...
<?php esc_html_e( 'Skip to content', 'skt-clover' ); ?>
</a>
<?php
...
<div class="header">
  <div class="container">
    <div class="logo">
		<?php skt_clover_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
    ...
    <div class="header-extras">
            	...
            	<div class="header-search-form">
                    <form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                      <input type="search" class="search-field" placeholder="<?php esc_attr_e( 'Search', 'skt-clover' ); ?>" name="s">
                      <input type="submit" class="search-submit" value="<?php esc_attr_e( 'Search', 'skt-clover' ); ?>">
                    </form>
          		</div>
            	<?php if ( class_exists( 'WooCommerce' ) ) { ?>
    			<li><div class="header-cart">
				<a class="cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'skt-clover' ); ?>"> <img class="cart-customlocation" src="<?php echo esc_url(get_template_directory_uri());?>/images/cart-icon.png" /> <span class="custom-cart-count"><div id="mini-cart-count"></div></span> </a>  
    			</div></li>
    <?php } ?>
    		<div class="clear"></div>
            </div>
